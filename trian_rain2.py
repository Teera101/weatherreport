...
models = {
    ...
    "Random Forest": RandomForestClassifier(n_estimators=107, random_state=42),
    "Gradient Boosting": GradientBoostingClassifier(n_estimators=98, random_state=42),
    "Genetic Algorithm (MLP)": MLPClassifier(hidden_layer_sizes=(10, 5), max_iter=500, random_state=42),
    "AdaBoost": AdaBoostClassifier(n_estimators=142, random_state=42)
}
...
joblib.dump(final_model, "best_model.pkl2")
