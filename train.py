...
models = {
    ...
    "MLP Neural Network": MLPClassifier(hidden_layer_sizes=(10, 5), max_iter=500, random_state=42),
...
cv_scores["Voting Classifier"] = np.mean(cross_val_score(voting_clf, X_train, y_train, cv=skf))
...
final_model = {"model": models[best_model] if best_model != "Voting Classifier" else voting_clf, "label_encoder": label_encoder}
